...
// Questions
var nodes = [{ "node": 1, "message": "Would you like to have Western dishes?", "yes": 3, "no": 2 },
             { "node": 2, "message": "Would you like to have Eastern dishes?", "yes": 7, "no": 1 },
             { "node": 3, "message": "Would you like to have American dishes?", "yes": 11, "no": 4 },
             { "node": 4, "message": "Would you like to have Italian dishes", "yes": 12, "no": 5 },
             { "node": 5, "message": "Would you like to have Greek dishes?", "yes": 16, "no": 6 },
             { "node": 6, "message": "Would you like to have Mexican dishes?", "yes": 15, "no": 2 },
             { "node": 7, "message": "Would you like to have Chinese dishes?", "yes": 13, "no": 8 },
			 { "node": 8, "message": "Would you like to have Japanese dishes?", "yes": 14, "no": 9 },
			 { "node": 9, "message": "Would you like to have Indian dishes?", "yes": 17, "no": 10 },
			 { "node": 10, "message": "Would you like to have Vietnamese dishes?", "yes": 18, "no": 1 },

// Answers & descriptions
             { "node": 11, "message": "American", "yes": 0, "no": 0, "description": "Hamburger, French Fries, Sandwich, Steak, and Fast Food." },
             { "node": 12, "message": "Italian", "yes": 0, "no": 0, "description": "Pizza, Calzone, Lasagne, Ravioli, and Spaghetti."},
             { "node": 13, "message": "Chinese", "yes": 0, "no": 0 , "description": "Fried Rice, Lo Mein, Chow Mein, General Tso's Chicken, and Mapo Tofu."},
             { "node": 14, "message": "Japanese", "yes": 0, "no": 0 , "description": "Soba, Udon, Ramen, Sushi, and Tonkatsu ."},
             { "node": 15, "message": "Mexican", "yes": 0, "no": 0 , "description": "Burrito, Salsa, Taco, Enchilada, and Tortilla."},
             { "node": 16, "message": "Greek", "yes": 0, "no": 0 , "description": "Baklava, Gyro, Greek Salad, Tzatziki, and Sofrito."},
             { "node": 17, "message": "Indian", "yes": 0, "no": 0 , "description": "Tandori Chicken, Biryani, Pakora, Curry, and Naan. "},
             { "node": 18, "message": "Vietnamese", "yes": 0, "no": 0 , "description": " Pho, Banh mi, Fishcake, Rice Roll, and Spring Rolls ."},
];
...
var welcomeMessage = "Welcome to Should I Eat, are you ready to play?";
...
var playAgainMessage = "Say 'tell me more' to hear a list of food for this type, or do you want to play again?";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will identify what you should eat next. Want to start now?";
